...
uniform float g_scale;			//controls the radius of occlusion
uniform float g_bias;			//>0 lighter <0 darker
uniform float g_intensity;		//>1 makes the shadows darker  
...
//const float g_bias =  -0.2;			//>0 lighter <0 darker
//const float g_intensity = 1.75;		//>1 makes the shadows darker
const int   NUM_SAMPLES = 16;		//number of samples
